            ...
            <div class="card border-grey border-lighten-2">
                ...
                <h4 id="url{{$i}}" class="card-title"><a target="_blank" href="{{$news->url}}">{{$news->url}}</a></h4>
                    <p class="card-subtitle text-muted mb-0 pt-1">
                        <span class="font-small-3"><span id="date_ajouter{{$i}}">{{$info->date_ajouter}}</span> By : <a href="/profil/{{$info->userEmail}}"><span id="authorEmail{{$i}}"> {{$info->userEmail}}</span></a></span>
                    </p>
